...
const pains = [
  {
    ...
    description: 'Masz dość wysokich opłat wstępnych i miesięcznych ropalty? Twoje pieniądze pracują na franczyzę zamiast na Ciebie.',
    impact: 'Tysięce miesięcznie'
  },
  {
    icon: DollarSign,
    title: 'Duże koszty stałe',
    description: 'Boisz się dużych kosztów stałych na start? Tradycyjne kawiarnie wymagają ogromnych nakładów początkowych.',
    impact: 'Ryzyko kapitałowe'
  },
  {
    icon: Users,
    title: 'Problemy kadrowe',
    description: 'Nie chcesz być zależny od humorów i zwolnień lekarskich pracowników? Pensje, grafiki, ZUS to ciągły ból głowy.',
    impact: 'Brak kontroli'
  },
  {
    icon: TrendingDown,
    title: 'Nieprzejrzysta ekonomia',
    description: 'Szukasz modelu biznesowego z przejrzystą ekonomią? Ukryte koszty i narzuceni dostawcy niszczą marże.',
